...
This wiki is a place to document GateKeeper's design and implementation as well as features and how to use them.
...
The Web module is a simple HTTP server that can be used to provide a web interface to the GateKeeper.
